...
@celery.task#(bind=True, max_retries=3, default_retry_delay=300)  # 5 minutes delay
...
@celery.task#(bind=True, max_retries=3, default_retry_delay=600)  # 10 minutes delay
